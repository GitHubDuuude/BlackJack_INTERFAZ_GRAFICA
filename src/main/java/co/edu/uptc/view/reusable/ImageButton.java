...
public class ImageButton extends JButton {
    ...
    public ImageButton(String text, boolean inverted) {
        ...
        if (inverted) {
            ...
            releasedColor = new Color(248,244,239,255);
        } else {
            releasedColor = new Color(71,45,60,255);
            pressedColor = new Color(248,244,239,255);
        }

        try {
            InputStream buttonStream = getClass().getResourceAsStream("/images/icons/button.png");
            InputStream pressedButtonStream = getClass().getResourceAsStream("/images/icons/pressed_button.png");
        ...
        try {
            ...
            // Fallback to default font if custom font cannot be loaded
